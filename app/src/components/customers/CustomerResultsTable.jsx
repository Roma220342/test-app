            ...
            {phase === 'loading'
              ...
              : customers.map((customer) => (
                  <tr
                    ...
                    className="cursor-pointer border-b border-border bg-surface transition-colors last:border-b-0 hover:bg-surface-hover-content focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-ink"
                  >
